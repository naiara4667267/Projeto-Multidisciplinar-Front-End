...
// Função da  máscara para digitar número telefone
...
function irLGPD() {
  ...
  if (!validarSenha(senha)) {
    erro.innerText = "Senha inválida. Use pelo menos 1 letra, 1 número e 1 caractere especial (@#$%&)";
    return;
  }

  // === salva dados ===
  localStorage.setItem("cliente", JSON.stringify({
    nome, telefone, cpf, email, nascimento, endereco, senha
  }));

  // === segue fluxo para LGPD ===
